...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="pd-20 card-box mb-30">
        <div class="clearfix">
            <div class="pull-left">
                <h4 class="text-blue h4">Tambah Data Obat</h4>
            </div>
        </div>
        <form action="/dashboard/obat" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group row mt-3">
                <label class="col-sm-12 col-md-2 col-form-label" for="kode_obat">Kode Obat</label>
                <div class="col-sm-12 col-md-10">
                    <input class="form-control @error('kode_obat') is-invalid @enderror" name="kode_obat" id="kode_obat"
                        value="{{ old('kode_obat') }}" type="text" placeholder="Masukkan kode obat">
                    @error('kode_obat')
            ...
            <div class="form-group row mt-3">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="form-control @error('nama_obat') is-invalid @enderror" name="nama_obat" id="nama_obat"
                        value="{{ old('nama_obat') }}" type="text" placeholder="Masukkan nama obat">
                    @error('nama_obat')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="form-control @error('harga') is-invalid @enderror" value="{{ old('harga') }}"
                        id="harga" name="harga" type="number" placeholder="Masukkan harga">
                    @error('harga')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="form-control @error('stok') is-invalid @enderror" value="{{ old('stok') }}" id="stok"
                        name="stok" type="number" placeholder="Masukkan stok">
                    @error('stok')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
