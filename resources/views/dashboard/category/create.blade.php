        ...
        <form action="/dashboard/category" method="POST">
            ...
            <div class="form-group row mt-3">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" type="text" value="{{ old('kode_kategori') }}" id="kode_kategori"
                        name="kode_kategori" placeholder="Masukkan kode kategori">
                </div>
            </div>
            <div class="form-group row mt-3">
                <label class="col-sm-12 col-md-2 col-form-label" for="nama_kategori">Nama Kategori</label>
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" type="text" value="{{ old('nama_kategori') }}" id="nama_kategori"
